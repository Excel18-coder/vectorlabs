...
const ProcessSection = () => {
  return (
    <section id="process" className="py-24 md:py-32 relative overflow-hidden bg-secondary/30">
      <div className="absolute inset-0 bg-gradient-to-b from-secondary/40 via-background to-secondary/35" />
      <svg className="absolute inset-0 w-full h-full opacity-35" preserveAspectRatio="none">
        <defs>
          <pattern id="flow" width="120" height="120" patternUnits="userSpaceOnUse">
            <path d="M 0 60 Q 30 30 60 60 T 120 60" fill="none" stroke="rgba(80,70,56,0.2)" strokeWidth="1" />
            <circle cx="60" cy="60" r="2" fill="rgba(80,70,56,0.26)" />
          </pattern>
        </defs>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {steps.map((step, i) => (
            <motion.div
              ...
              className="relative rounded-2xl border border-border/80 bg-background/95 p-8 shadow-sm"
            >
